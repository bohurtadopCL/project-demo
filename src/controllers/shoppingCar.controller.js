...
exports.find = async function (req, res) {
  ...
  try {
    ...
    if (items) {
      ...
      if (res) {
        res.send(items.slice(req.params.offset || 0, req.params.limit + req.params.offset || 25));
      } else {
        return items.slice(req.params.offset || 0, req.params.limit + req.params.offset || 25);
      }
    } else {
